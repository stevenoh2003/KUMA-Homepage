  ...
  const features = [
    {
      ...
      title: "Blogs",
      desc: "Research new knowledge, document your findings, and publish them as blogs. ",
    },
    {
      icon: (
        <svg
      ...
      title: "Projects",
      desc: "Build hands-on projects, discuss with kuma members, and showcase them.",
    },
    {
      icon: (
        <svg
      ...
      title: "Events",
      desc: "In-house paper reading sessions, mini-hackathon, and more.",
    },
  ]
